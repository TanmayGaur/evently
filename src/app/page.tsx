  ...
  return (
    <main className="min-h-screen bg-gradient-dark flex flex-col">
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-4">
        ...
        <button className="bg-gradient-brand px-8 py-3 rounded-lg text-white font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 animate-pulse-glow">
          Get Started
        </button>
      </section>
